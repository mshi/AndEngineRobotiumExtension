...
public class AndEngineSolo extends Solo {
    ...
    public AndEngineSolo(final Instrumentation pInstrumentation, final Activity pActivity) {
        ...
        if (!(pActivity instanceof BaseGameActivity)) {
            Assert.fail("The supplied " + Activity.class.getSimpleName() + " does not subclass '" + BaseGameActivity.class.getSimpleName() + "' but is a '"
                    + pActivity.getClass().getSimpleName() + "'.");
        }
    }
    ...
    public void assertEntityRotationCenter(final float pExpectedRotationCenterX, final float pExpectedRotationCenterY, final Class<? extends IEntity> pClass,
            final Object pTag) {
    ...
    public void assertEntityRotationCenter(final float pExpectedRotationCenterX, final float pExpectedRotationCenterY, final Class<? extends IEntity> pClass,
            final Object pTag, final float pDelta) {
    ...
    public void assertEntityScaleCenter(final float pExpectedScaleCenterX, final float pExpectedScaleCenterY, final Class<? extends IEntity> pClass,
            final Object pTag) {
    ...
    public void assertEntityParent(final Class<? extends IEntity> pExpectedParentClass, final Object pExpectedParentTag, final Class<? extends IEntity> pClass,
            final Object pTag) {
    ...
    public void assertEntityChild(final Class<? extends IEntity> pExpectedChildClass, final Object pExpectedChildTag, final Class<? extends IEntity> pClass,
            final Object pTag) {
        Assert.assertSame(this.getEntityParent(pExpectedChildClass, pExpectedChildTag), this.getUniqueEntityByTag(pClass, pTag));
    }

    public void assertEntityChild(final int pIndex, final Class<? extends IEntity> pExpectedChildClass, final Object pExpectedChildTag,
            final Class<? extends IEntity> pClass, final Object pTag) {
